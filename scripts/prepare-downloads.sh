...
## akka-grpc-quickstart-java zip file
prepareTemporalFolder
fetchProject ${samples_sources}/akka-grpc-quickstart-java akka-grpc-quickstart
zipAndAttach ${docs_attachments}/akka-grpc-quickstart-java.zip ${target_temporal_attachments}

## akka-grpc-quickstart-scala zip file
prepareTemporalFolder
fetchProject ${samples_sources}/akka-grpc-quickstart-scala akka-grpc-quickstart
zipAndAttach ${docs_attachments}/akka-grpc-quickstart-scala.zip ${target_temporal_attachments}
