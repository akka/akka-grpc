...
import io.grpc.testing.integration.test.{ RawTestServiceClient, UnimplementedServiceClient }
...
class AkkaGrpcClientTester(val settings: Settings)(implicit mat: Materializer, sys: ActorSystem) extends ClientTester {
  ...
  def clientCompressedStreaming(probe: Boolean): Unit = {
    throw new RuntimeException("Not implemented! clientCompressedStreaming") with NoStackTrace
  }
