...
object Dependencies {
  object Versions {
    ...
    val grpc = "1.36.0" // checked synced by GrpcVersionSyncCheckPlugin
  ...
  object Compile {
    ...
    val akkaHttpCors = "ch.megard" %% "akka-http-cors" % "1.1.1" // Apache v2
  ...
  object Protobuf {
    val googleCommonProtos = "com.google.protobuf" % "protobuf-java" % "3.15.6" % "protobuf"
  }
