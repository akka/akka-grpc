                ...
                all().each { task ->
                    ...
                    task.plugins {
                        akkaGrpc {
                            ...
                            if (akkaGrpcExt.clientInclude) { option "client_include=${akkaGrpcExt.clientInclude.join(';')}" }
                            if (akkaGrpcExt.clientExclude) { option "client_exclude=${akkaGrpcExt.clientExclude.join(';')}" }
